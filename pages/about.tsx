    ...
    <Layout>
      <SmoothScrollWrapper>
        <div id="aboutWrapper" className="z-30 overflow-hidden relative">
          ...
          <div id="aboutSectionOne" className="headerTrigger bg-gray-100 grid md:grid-cols-2">
            <div className="overflow-hidden">
              <div className="relative about-1">
                <img src="/aboutimg2.jpg" alt="" className="h-full w-full about-1-img" />
              </div>  
            </div>

            <div className="flex flex-col space-y-5 justify-center md:p-10 p-6">
              <h1 className="md:text-8xl sm:text-6xl text-4xl text-gray-800">Overview</h1>
              <p className="md:text-2xl sm:text-lg text-sm font-sans text-gray-600">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste odio, eaque natus officia ipsam dolores repudiandae magni, quas odit sequi dicta ullam distinctio laborum hic quidem temporibus asperiores, esse ea!
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste odio, eaque natus officia ipsam dolores repudiandae magni, quas odit sequi dicta ullam distinctio laborum hic quidem temporibus asperiores, esse ea!
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste odio, eaque natus officia ipsam dolores repudiandae magni, quas odit sequi dicta ullam distinctio laborum hic quidem temporibus asperiores, esse ea!
              </p>
            </div>
          ...
          <div id="aboutSectionTwo" className="section headerTrigger grid md:grid-cols-2 py-24">

            <div className="flex flex-col space-y-5 justify-center md:p-10 p-6">
              <h1 className="md:text-8xl sm:text-6xl text-4xl text-gray-200 sm:w-auto w-48">Benefits we bring</h1>
            </div>
          ...
          <div id="aboutSectionThree" className="section bg-gray-100 headerTrigger py-32 text-gray-800">
            ...
            <div className="w-full text-center md:p-10 p-6">
              ...
              <p className="pt-7 font-sans">
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Inventore, dolorum pariatur culpa consectetur nesciunt tenetur velit labore architecto obcaecati, sunt provident numquam tempore maxime at vitae aut fuga qui sint.
              </p>
            </div>
          ...
          <div id="aboutSectionFour" className="headerTrigger flex">
            <div className="w-full grid md:grid-cols-2">
              <div className="relative flex justify-center overflow-hidden">
                <img src="/chennai-bw.jpg" alt="" className="w-full h-full about-2-img" />
              </div>

              <div className="flex flex-col justify-center p-10 bg-gray-800">
                <h1 className="md:text-8xl text-white sm:text-6xl text-4xl">Our Office</h1>
                <p className="font-sans mt-7 md:text-2xl sm:text-lg text-sm text-gray-300">Our office is located in Chennai which is the third largest software exporter in India.</p>
                <Link href={"/contact"}>
          ...
          <div id="aboutSectionFive" className="headerTrigger bg-gray-100 flex flex-col justify-center section items-center p-10">
